...
class Encoder(nn.Module):
    ...
    def __init__(self, channels=128, channel_multipliers=[1, 2, 4, 4], n_resnet_blocks=2, in_channels=3, z_channels=4):
        """
...
class Decoder(nn.Module):
    ...
    def __init__(self, channels=128, channel_multipliers=[1, 2, 4, 4], n_resnet_blocks=2, out_channels=3, z_channels=4):
        """
