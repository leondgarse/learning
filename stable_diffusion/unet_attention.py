...
This implements the transformer module used in [U-Net](unet.html) that gives $\epsilon_\text{cond}(x_t, c)$
We have kept to the model definition and naming unchanged from [CompVis/stable-diffusion](https://github.com/CompVis/stable-diffusion)
...
class FeedForward(nn.Module):
    def __init__(self, d_model: int, d_mult: int = 4):
        ...
        """
        super().__init__()
        self.net = nn.Sequential(GeGLU(d_model, d_model * d_mult), nn.Dropout(0.0), nn.Linear(d_model * d_mult, d_model))
